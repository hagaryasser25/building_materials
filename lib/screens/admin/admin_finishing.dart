...
class AdminFinishing extends StatefulWidget {
  static const routeName = '/adminFinishing';
  const AdminFinishing({super.key});

  @override
  State<AdminFinishing> createState() => _AdminFinishingState();
}

class _AdminFinishingState extends State<AdminFinishing> {
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: TextButton.icon(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, AddFinishing.routeName);
                  },
                )),
          ),
          body: Container(
